...
top_revenue_item = find_top_entry(item_summary, field="revenue")
top_units_item = find_top_entry(item_summary, field="units_sold")
...
print()
print(f"Top seller by revenue: {top_revenue_item['item']} (${top_revenue_item['revenue']:,.2f})")
print(f"Top seller by units:   {top_units_item['item']} ({top_units_item['units_sold']} units)")
